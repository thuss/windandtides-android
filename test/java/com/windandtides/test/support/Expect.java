...
public class Expect {
    ...
    public static <T extends android.view.View, M extends com.windandtides.test.support.matchers.android.ViewMatcher<T, M>> com.windandtides.test.support.matchers.android.ViewMatcher<T, ?> expect(T actual) {
        return wrapped(com.windandtides.test.support.matchers.android.ViewMatcher.class, actual);
    }
}
